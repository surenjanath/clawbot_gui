...
- **Desktop GUI** (`claw gui`): egui-based Ollama chat, settings, and session persistence — see [`gui.md`](gui.md)
...
For GUI-specific behavior, prerequisites, and limitations, see [`gui.md`](gui.md).
